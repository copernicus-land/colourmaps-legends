...
<qgis minScale="1e+08" autoRefreshMode="Disabled" hasScaleBasedVisibilityFlag="0" version="3.44.3-Solothurn" maxScale="0" autoRefreshTime="0" styleCategories="LayerConfiguration|Rendering|CustomProperties|Temporal">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" type="paletted" band="1" alphaBand="-1" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry color="#000000" alpha="255" value="0" label="cloud-free / cloud shadow-free" />
        <paletteEntry color="#fee6ce" alpha="255" value="1" label="high cloud" />
        <paletteEntry color="#f29e6e" alpha="255" value="2" label="other cloud" />
        <paletteEntry color="#e6550d" alpha="255" value="3" label="cloud shadow" />
