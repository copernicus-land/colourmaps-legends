...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>clms_hrlvlcc_cpcsy</sld:Name>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="values">
              ...
              <sld:ColorMapEntry color="#e79d1d" label="1 growing season" quantity="1"/>
              <sld:ColorMapEntry color="#8ae937" label="2 growing seasons" quantity="2"/>
