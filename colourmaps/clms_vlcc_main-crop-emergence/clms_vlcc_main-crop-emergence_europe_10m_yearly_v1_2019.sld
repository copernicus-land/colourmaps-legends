...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>clms_hrlvlcc_cpmce_2019</sld:Name>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="ramp">
              ...
              <sld:ColorMapEntry color="#488743" label="Aug 2018" quantity="18213"/>
              <sld:ColorMapEntry color="#65cc81" label="Sep 2018" quantity="18244"/>
              <sld:ColorMapEntry color="#7dfcc8" label="Oct 2018" quantity="18275"/>
              <sld:ColorMapEntry color="#80ffdf" label="Nov 2018" quantity="18305"/>
              <sld:ColorMapEntry color="#80dfff" label="Dec 2018" quantity="18335"/>
              ...
              <sld:ColorMapEntry color="#ff7fa1" label="Apr 2019" quantity="19120"/>
              <sld:ColorMapEntry color="#ffb07f" label="May 2019" quantity="19151"/>
              <sld:ColorMapEntry color="#ffdf80" label="Jun 2019" quantity="19181"/>
              <sld:ColorMapEntry color="#dfff80" label="Jul 2019" quantity="19212"/>
              <sld:ColorMapEntry color="#9fff80" label="Aug 2019" quantity="19243"/>
              <sld:ColorMapEntry color="#6ddc8d" label="Sep 2019" quantity="19273"/>
