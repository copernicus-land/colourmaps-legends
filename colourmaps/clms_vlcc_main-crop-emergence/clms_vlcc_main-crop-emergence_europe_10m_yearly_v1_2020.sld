...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>clms_hrlvlcc_cpmce_2020</sld:Name>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="ramp">
              ...
              <sld:ColorMapEntry color="#488743" label="Aug 2019" quantity="19213"/>
              <sld:ColorMapEntry color="#65cc81" label="Sep 2019" quantity="19244"/>
              <sld:ColorMapEntry color="#7dfcc8" label="Oct 2019" quantity="19275"/>
              <sld:ColorMapEntry color="#80ffdf" label="Nov 2019" quantity="19305"/>
              <sld:ColorMapEntry color="#80dfff" label="Dec 2019" quantity="19335"/>
              ...
              <sld:ColorMapEntry color="#ff7fa1" label="Apr 2020" quantity="20121"/>
              <sld:ColorMapEntry color="#ffb07f" label="May 2020" quantity="20152"/>
              <sld:ColorMapEntry color="#ffdf80" label="Jun 2020" quantity="20182"/>
              <sld:ColorMapEntry color="#dfff80" label="Jul 2020" quantity="20213"/>
              <sld:ColorMapEntry color="#9fff80" label="Aug 2020" quantity="20244"/>
              <sld:ColorMapEntry color="#6ddc8d" label="Sep 2020" quantity="20274"/>
