...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>CLMS_HRLVLCC_CPMCE_S2024_R10m</sld:Name>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="ramp">
              ...
              <sld:ColorMapEntry label="Nov 2023" color="#80ffdf" quantity="23306"/>
              <sld:ColorMapEntry label="Dec 2023" color="#80dfff" quantity="23336"/>
              ...
              <sld:ColorMapEntry label="Apr 2024" color="#ff7fa1" quantity="24120"/>
              <sld:ColorMapEntry label="May 2024" color="#ffb07f" quantity="24151"/>
              <sld:ColorMapEntry label="Jun 2024" color="#ffdf80" quantity="24181"/>
              <sld:ColorMapEntry label="Jul 2024" color="#dfff80" quantity="24212"/>
              <sld:ColorMapEntry label="Aug 2024" color="#9fff80" quantity="24243"/>
              <sld:ColorMapEntry label="Sep 2024" color="#6ddc8d" quantity="24273"/>
