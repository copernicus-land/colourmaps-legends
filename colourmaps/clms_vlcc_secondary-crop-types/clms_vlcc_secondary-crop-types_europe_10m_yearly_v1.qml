  ...
  <pipe>
    <rasterrenderer band="1" type="paletted" alphaBand="-1" opacity="1">
      ...
      <colorPalette>
        ...
        <paletteEntry color="#fecb5b" label="Short summer CC" value="1" alpha="255"/>
        <paletteEntry color="#ff9e01" label="Long summer CC" value="2" alpha="255"/>
        <paletteEntry color="#63e53b" label="Short winter CC" value="3" alpha="255"/>
        <paletteEntry color="#106400" label="Long winter CC" value="4" alpha="255"/>
        <paletteEntry color="#e1e1e1" label="65526" value="65526" alpha="255"/>
        <paletteEntry color="#c8c8c8" label="65527" value="65527" alpha="255"/>
        <paletteEntry color="#7d7d7d" label="65530" value="65530" alpha="255"/>
        ...
        <paletteEntry color="#b330b3" label="65534" value="65534" alpha="255"/>
