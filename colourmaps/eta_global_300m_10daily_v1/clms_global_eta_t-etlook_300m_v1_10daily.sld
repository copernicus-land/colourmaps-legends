...
<StyledLayerDescriptor version="1.0.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <Title>clms_global_eta_t-etlook_300m_v1_10daily</Title>
      <Abstract>Dekadal average of daily total water flux from canopy transpiration, ETLook model</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <RasterSymbolizer>
