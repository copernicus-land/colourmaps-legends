...
<StyledLayerDescriptor version="1.0.0" 
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <Title>clms_global_eta_t-ensemble_300m_v1_10daily</Title>
      <Abstract>Dekadal average of daily total water flux from canopy transpiration, average of ETLook and TSEB-PT model</Abstract>
      <FeatureTypeStyle>
        <Rule>
          <RasterSymbolizer>
