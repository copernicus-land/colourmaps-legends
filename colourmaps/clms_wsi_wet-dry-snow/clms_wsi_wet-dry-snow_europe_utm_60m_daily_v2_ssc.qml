...
<qgis minScale="1e+08" autoRefreshMode="Disabled" hasScaleBasedVisibilityFlag="0" version="3.44.3-Solothurn" maxScale="0" autoRefreshTime="0" styleCategories="LayerConfiguration|Rendering|CustomProperties|Temporal">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" type="paletted" band="1" alphaBand="-1" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry color="#ff00ff" alpha="255" value="110" label="wet snow" />
        <paletteEntry color="#ffffff" alpha="255" value="115" label="dry snow" />
        <paletteEntry color="#e1e65a" alpha="255" value="120" label="snow free / patchy snow cover" />
        <paletteEntry color="#282828" alpha="255" value="200" label="radar shadow / layover / foreshortening " />
        <paletteEntry color="#7b7b7b" alpha="255" value="205" label="cloud / cloud shadow" />
        <paletteEntry color="#6464d7" alpha="255" value="210" label="water" />
        <paletteEntry color="#19a023" alpha="255" value="220" label="forest" />
        <paletteEntry color="#ffbe64" alpha="255" value="230" label="urban area" />
