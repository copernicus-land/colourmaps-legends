...
<qgis hasScaleBasedVisibilityFlag="0" version="3.10.3-A Coruña" minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    <rasterrenderer opacity="1" band="1" type="paletted" alphaBand="-1">
      ...
      <colorPalette>
        <paletteEntry label="0: non-grassland in reference year" value="0" color="#f0f0f0" alpha="255"/>
        <paletteEntry label="1: permanent and temporary grassland in reference year" value="1" color="#74970b" alpha="255"/>
